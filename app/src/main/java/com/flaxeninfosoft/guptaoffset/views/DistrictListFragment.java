...
import com.flaxeninfosoft.guptaoffset.databinding.FragmentDistrictListBinding;
...
public class DistrictListFragment extends Fragment {
    ...
    FragmentDistrictListBinding binding;
    List<DistrictData> districtDataList;
    RequestQueue requestQueue;
    DistrictListRecyclerAdapter adapter;
    Gson gson;
    Long empId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_district_list, container, false);
        ...
        adapter = new DistrictListRecyclerAdapter(districtDataList, this::onClickDistrict);
